function [psi,phi,output] = uv2psiphi(psi0,phi0,uflx,vflx,cxy,alpha,opt)
...
%      cxy           : Struct of factors for finite differece, used in
%                      'derive_A.m'
...
[x_optm, fval, ~, output] = minFunc(fh,x0,opt);
fprintf('F(x): %f\n',fval)
disp(output)
